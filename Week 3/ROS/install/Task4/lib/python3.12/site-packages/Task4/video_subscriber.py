...
class VideoSubscriber(Node):
    def __init__(self):
        ...
        self.subscription_ = self.create_subscription(
            Image,
            'video_feed',         # Must match the publisher's topic
    ...
    def listener_callback(self, msg):
        try:
            # Convert the ROS 2 Image message back to an OpenCV image
        ...
        cv2.waitKey(1) # This is crucial for the window to refresh
